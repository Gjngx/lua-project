...
export class Header {
	...
	setupSocialHovers() {
		this.playHoverButtons = $(this.el).find('.header-menu-play, .header-menu-skip').toArray();
		this.playHoverButtons.forEach((button) => {
			$(button).on('pointerenter', this.handlePlayHoverPoint);
